            ...
            <form method="get" class="form-search">
                <div class="filters">
                    <div class="form-group select">
                        <div class="select">
                            <select id="search_key" name="key" data-placeholder="{{__('voyager::hotdesk.content_search_key')}}">
                    ...
                    <div class="form-group select">
                        <div class="select">
                            <select id="filter" name="filter" data-placeholder="{{__('voyager::hotdesk.content_search_filter')}}"
