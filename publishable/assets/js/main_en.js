...
$(document).ready(function() {
        ...
        $(".replaychat .chatbox .messages").mCustomScrollbar({
            ...
            callbacks: {
                onTotalScrollBack: function() {
                    ...
                    if (morepage == true) {
                        var loading = $('<div class="message me loading"><div style="width:100%"><p style="text-align:center"> loading more ...</p></div></div>');
    ...
    $('.layout .main .chart .box ul li').click(function() {
        if (transactiondata != null && userdata != null) {
            ...
            if ($(this).data('id') == "orders") {
                userchart.data.datasets[0].label = "Sell";
                userchart.data.datasets[0].data = transactiondata;
            } else if ($(this).data('id') == "users") {
                userchart.data.datasets[0].label = "User";
                userchart.data.datasets[0].data = userdata;
            }
            userchart.update();
        }
    ...
    $('.layout .main .notes .textbox .bottom button').click(function() {
        ...
        $.post("/admin/notes/set", {
            ...
            var data = $('<div class="item ' + className + '"><div class="avatar"><img src="' + avatar + '" onerror="this.className=\'none\'" alt="' + singlelettername + '" title="' + singlelettername + '"><span>' + singlelettername + '</span></div><div class="notedata"><p>' + text + '</p><div class="action"><button type="button" class="deletenote" data-id="' + data.data.id + '"><span>delete</span></button></div></div></div>');
    ...
    $('.form-group input[type=password]').keyup(function() {
        ...
        if (password.length < 7) {
            $(this).parents('.form-group').find('.checklist .Strength ul li.message').text('unacceptable');
    ...
    $('.layout .main .dashboard .smspack .box .actions input').keyup(function() {
        var count = $(this).val();
        $('.layout .main .dashboard .smspack .box .actions button.pay span').text('pay ' + count + ' $');
    });
    ...
    $('table thead th .checkbox.select').click(function() {
        if ($(this).prop('checked') === true) {
            ...
            $('.layout .main .header .action button.delete').text('Bulk Delete');
        } else {
            ...
            $('.layout .main .header .action button.delete').text('Delete');
        }
    });
    ...
    $('.layout .main .content .post .block .getimdbdata').click(function() {
        ...
        var btn = this;
        if (!patt.test(imdbid)) {
            toastr.error("Imdb id is invalid", "error");
        } else {
            ...
            $.get("/admin/imdb/init", {
                ...
                if (data.success == true) {
                    ...
                    if (data.message == 'http')
                        ...
                        toastr.error("Failed operation", "error");
                }
            });
        }
    });
    ...
    */
    $('.layout .main .content .post .block .getallimdbdata').click(function() {
        ...
        if (!patt.test(imdbid)) {
            ...
            var general = toastr.warning("Getting information", "", {
                timeOut: 0,
                extendedTimeOut: 0
            });
            $.get("/admin/imdb/general", {
                ...
                general.remove();
                if (data.success == true) {
                    toastr.success("Information received", "");
                    ...
                    $('.form-addable.trailer .data').html('<div class="item"><div class="row"><div class="form-group gray"><label>Trailer link</label><input type="text" name="trailers[]" class="dir_ltr"></div><div class="action"><button type="button" name="button" class="deleteform"></button></div></div></div>');
                    if (data.data.trailers) {
                        var trailers = toastr.warning("Registering Trailers", "", {
                            timeOut: 0,
                            extendedTimeOut: 0
                        });
                        $.post("/admin/imdb/trailer", {
                            ...
                            step++;
                            trailers.remove();
                            toastr.success("Trailers received", "");
                            $('.form-addable.trailer .data').html('');
                            $.each(data.data, function(i, item) {
                                var dataitem = $('<div class="item"><div class="row"><div class="form-group gray"><label>Trailer link</label><input type="text" name="trailers[]" class="dir_ltr" value=""></div><div class="action"><button type="button" name="button" class="deleteform"></button></div></div></div>');
            ...
            var genre = toastr.warning("Registering Genres", "", {
                timeOut: 0,
                extendedTimeOut: 0
            });
            ...
            $.post("/admin/imdb/genre", {
                ...
                genre.remove();
                if (data.success == true) {
                    toastr.success("Genres Registered", "");
                    var keys = [];
                    $.each(data.data, function(i, item) {
                        keys[i] = item.id;
                    ...
                    if (data.message == 'http')
                        toastr.error("Not Found", "Genres");
                    else
                        toastr.error("Unsuccessful Operation", "Genres");
                }
            });
            var country = toastr.warning("Country Registration", "", {
                timeOut: 0,
                extendedTimeOut: 0
            });
            ...
            $.post("/admin/imdb/country", {
                ...
                country.remove();
                if (data.success == true) {
                    toastr.success("Countries Registered", "");
                    var keys = [];
                    $.each(data.data, function(i, item) {
                        keys[i] = item.id;
                    ...
                    if (data.message == 'http')
                        toastr.error("Not Found", "Countries");
                    else
                        toastr.error("Failed Operations", "Countries");
                }
            });
            var language = toastr.warning("Registering Languages", "", {
                timeOut: 0,
                extendedTimeOut: 0
            });
            ...
            $.post("/admin/imdb/language", {
                ...
                language.remove();
                if (data.success == true) {
                    toastr.success("Languages registered", "");
                    var keys = [];
                    $.each(data.data, function(i, item) {
                        keys[i] = item.id;
                    ...
                    if (data.message == 'http')
                        toastr.error("Not Found", "Languages");
                    else
                        toastr.error("Failed Operations", "Languages");
                }
            });
            var cover = toastr.warning("Taking Cover and Resizing", "", {
                timeOut: 0,
                extendedTimeOut: 0
            });
            ...
            $.post("/admin/imdb/poster", {
                ...
                if (data.success == true) {
                    ...
                    if (data.message == 'http')
                        toastr.error("Not Found", "Cover");
                    else
                        toastr.error("Failed Operation", "Cover");
                }
            });
            var casts = toastr.warning("Making Artist Pages", "", {
                timeOut: 0,
                extendedTimeOut: 0
            });
            ...
            $.post("/admin/imdb/casts", {
                ...
                casts.remove();
                if (data.success == true) {
                    toastr.success("Artist pages Creation Successful", "");
                    var keys = [];
                    $.each(data.data, function(i, item) {
                        keys[i] = item.id;
                    ...
                    if (data.message == 'http')
                        toastr.error("Not Found", "Artists");
                    else
                        toastr.error("Failed Operation", "Artists");
                }
            });
            var director = toastr.warning("Making Director Pages", "", {
                timeOut: 0,
                extendedTimeOut: 0
            });
            ...
            $.post("/admin/imdb/casts", {
                ...
                director.remove();
                if (data.success == true) {
                    toastr.success("Director Pages Creation Successful", "");
                    var keys = [];
                    $.each(data.data, function(i, item) {
                        keys[i] = item.id;
                    ...
                    if (data.message == 'http')
                        toastr.error("Not Found", "Director");
                    else
                        toastr.error("Failed Operation", "Director");
                }
            });
            var writing = toastr.warning("Making Writer Pages", "", {
                timeOut: 0,
                extendedTimeOut: 0
            });
            ...
            $.post("/admin/imdb/casts", {
                ...
                writing.remove();
                if (data.success == true) {
                    toastr.success("Writer Pages Creation Successful", "");
                    var keys = [];
                    $.each(data.data, function(i, item) {
                        keys[i] = item.id;
                    ...
                    if (data.message == 'http')
                        toastr.error("Not Found", "Writer");
                    else
                        toastr.error("Failed Operations", "Writer");
                }
            });
            var composer = toastr.warning("Making Composer Pages", "", {
                timeOut: 0,
                extendedTimeOut: 0
            });
            ...
            $.post("/admin/imdb/casts", {
                ...
                composer.remove();
                if (data.success == true) {
                    toastr.success("Composer Pages Creation Successful", "");
                    var keys = [];
                    $.each(data.data, function(i, item) {
                        keys[i] = item.id;
                    ...
                    if (data.message == 'http')
                        toastr.error("Not Found", "Composer");
                    else
                        toastr.error("Unsuccessful Operation", "Composer");
                }
            });
            ...
            var checkfinish = setInterval(function() {
                if (step == 9) {
                    ...
                    toastr.success("Movie data capture was successful", "");
    ...
    $(".form-edit-add.contents").submit(function(e) {
        ...
        if (patt.test(imdbid)) {
            ...
            var general = toastr.warning("Updating information", "", {
                timeOut: 0,
                extendedTimeOut: 0
            });
            $.get("/admin/imdb/general", {
                ...
                general.remove();
                if (data.success == true) {
                    toastr.success("Updated information", "");
                    $('input[name=mpaa]').val(data.data.mpaa);
                    $('input[name=oscar_won]').val(data.data.awardsparse ? data.data.awardsparse['oscar_won'] : 0);
                    $('input[name=oscar_nominee]').val(data.data.awardsparse ? data.data.awardsparse['oscar_nominee'] : 0);
                    $('input[name=golden_globe_won]').val(data.data.awardsparse ? data.data.awardsparse['golden_globe_won'] : 0);
    ...
    $(".layout .main .content .filters .button-group button.update250").click(function(e) {
        $(this).addClass('loading');
        var btn = this;
        var general = toastr.warning("Updating Top 250 Movies and Serials. This process may take some time", "", {
            timeOut: 0,
            extendedTimeOut: 0
        });
        $.get("/admin/imdb/update250", function(data) {
            ...
            $(btn).removeClass('loading');
            if (data.success == true) {
                toastr.success("Top 250 Movies and Serials Updated", "");
            }
        });
    });
    $(".layout .main .content .filters .button-group button.updatechart").click(function(e) {
        $(this).addClass('loading');
        var btn = this;
        var general = toastr.warning("Updating serial playlist. This process may take some time", "", {
            timeOut: 0,
            extendedTimeOut: 0
        });
