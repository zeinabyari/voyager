...
class DataRowsTableSeeder extends Seeder{
    ...
    public function run(){
        ...
        $metaDataType = DataType::where('slug', 'metas')->firstOrFail();
        ...
        $dataRow = $this->dataRow($metaDataType, 'id');
        if(!$dataRow->exists){
            $dataRow->fill([
                'type' => 'number',
                'display_name' => __('voyager::seeders.data_rows.id'),
        ...
        $dataRow = $this->dataRow($metaDataType, 'title');
        if(!$dataRow->exists){
            $dataRow->fill([
                'type' => 'text',
        ...
        $dataRow = $this->dataRow($metaDataType, 'name');
        if(!$dataRow->exists){
            $dataRow->fill([
                'type' => 'text',
                'display_name' => __('voyager::seeders.data_rows.name'),
        ...
        $dataRow = $this->dataRow($metaDataType, 'created_at');
        if(!$dataRow->exists){
            $dataRow->fill([
                'type' => 'timestamp',
                'display_name' => __('voyager::seeders.data_rows.created_at'),
        ...
        $dataRow = $this->dataRow($metaDataType, 'updated_at');
        if(!$dataRow->exists){
            $dataRow->fill([
                'type' => 'timestamp',
                'display_name' => __('voyager::seeders.data_rows.updated_at'),
